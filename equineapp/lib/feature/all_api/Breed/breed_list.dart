...
class BreedListPage extends StatefulWidget {
  @override
  _BreedListPageState createState() => _BreedListPageState();
}
...
class _BreedListPageState extends State<BreedListPage> {
  ...
  Future<void> _fetchBreeds() async {
    ...
    final String apiUrl = "https://mindari.ae:7449/tracker/mindari-tracker/breed";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        List<dynamic> data = json.decode(response.body)['breeds'];
        setState(() {
