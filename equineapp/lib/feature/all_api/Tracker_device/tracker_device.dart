...
class TrackerDeviceForm extends StatefulWidget {
  @override
  _TrackerDeviceFormState createState() => _TrackerDeviceFormState();
}

class _TrackerDeviceFormState extends State<TrackerDeviceForm> {
        ...
        child: Row(
          ...
          children: [
            ElevatedButton(
              ...
              child: Text('ADD TRACKER DEVICE'),
            ),
            ElevatedButton(
              onPressed: () {
                router.go(RoutePath.trackerdevicelist);
              },
              child: Text('VIEW TRACKER DEVICES'),
            ),
          ],
        ),
      ),
