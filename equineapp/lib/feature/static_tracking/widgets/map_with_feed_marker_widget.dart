...
import '../../common/widgets/map_label_value_widget.dart';

class MapWithFeedMarkerWidget extends StatefulWidget {
  ...
  @override
  State<MapWithFeedMarkerWidget> createState() => MapWidgetState();
}

class MapWidgetState extends State<MapWithFeedMarkerWidget> {
                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            Align(
                              ...
                              MapLabelValueWidget(label: 'HeartBeat', value: selectedFeedEntry.heartRate + ' bpm', isPortrait: true),
                              MapLabelValueWidget(label: 'Speed', value: selectedFeedEntry.speed + ' km/h', isPortrait: true),
                              MapLabelValueWidget(label: 'Time', value: DateFormat.Hms().format(selectedFeedEntry.dateTime), isPortrait: true),
                            ]
                        )
                    ),
                    CustomPaint(size: Size(10, 10), painter: DrawTriangleForMap()),
                    ]),
                  ),
                ),
            ])
