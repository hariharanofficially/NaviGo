...
import 'package:EquineApp/feature/subscripition/add_forms/Participants/view/add_participants.dart';
...
import 'package:EquineApp/feature/subscripition/manage_dashboard/cards/participant_dashboard/bloc/participant_dashboard_event.dart';
import 'package:EquineApp/feature/subscripition/manage_dashboard/cards/participant_dashboard/bloc/participant_dashboard_state.dart';
...
import '../../../../add_forms/Participants/bloc/add_participants_bloc.dart';
...
class ParticipantDashboard extends StatefulWidget {
  String eventId = "";
  ParticipantDashboard({super.key, required this.eventId});

  @override
  State<ParticipantDashboard> createState() =>
      _ParticipantDashboardState(eventId: eventId);
}

class _ParticipantDashboardState extends State<ParticipantDashboard> {
  int selectedTab = 0;
  String eventId = "";
  _ParticipantDashboardState({required this.eventId});
  @override
  void initState() {
    super.initState();
    context.read<ParticipantBloc>().add(LoadParticipants(eventId: eventId));
  }
        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            child: Padding(
              ...
              child: state is ParticipantLoading
                  ? Center(child: CircularProgressIndicator())
                  : state is ParticipantLoaded
                      ? Column(
                          children: [
                            Row(
                              children: [
...
class ParticipantItem extends StatelessWidget {
  final Participant participantName;
  String eventId = "";
  ParticipantItem(
      {super.key, required this.eventId, required this.participantName});
                          ...
                          onSelected: (value) {
                            switch (value) {
                              ...
                              case 'delete':
                                ...
                                // context.read<ParticipantBloc>().add(DeleteParticipants(ParticipantsId: participantName.id, eventId: ''));
