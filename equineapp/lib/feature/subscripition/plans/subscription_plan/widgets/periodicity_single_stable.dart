...
class MyBottomSheet1 extends StatefulWidget {
  const MyBottomSheet1(
  ...
  @override
  State<MyBottomSheet1> createState() => _MyBottomSheet1State();
}

class _MyBottomSheet1State extends State<MyBottomSheet1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Single Stable (Individual)'),
      ),
        ...
        child: ElevatedButton(
          onPressed: () {
            if (_selectedOption.isNotEmpty &&
              ...
              //    // builder: (context) => ReviewPage(subPlan: 'Single Stable (Individual)', selectedDate: _selectedDate, selectedOption: _selectedOption,noofStables: widget.noofStables,noofHorse: widget.noofHorse,noofEvents: ''),
              //   ),
              // );
            } else {
